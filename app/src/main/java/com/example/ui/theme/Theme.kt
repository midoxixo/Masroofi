...
private val LightThemeTurquoiseDream = lightColorScheme(
    ...
    onPrimary = Color(0xFFFFFFFF),
    primaryContainer = Color(0xFFF3E8FF), // Light Purple Container (Mixed!)
    onPrimaryContainer = Color(0xFF5B21B6),
    secondary = Color(0xFFC084FC), // Light Purple
    onSecondary = Color(0xFFFFFFFF),
    secondaryContainer = Color(0xFFCCFBF1), // Light Turquoise Container (Mixed!)
...
private val DarkThemeTurquoiseDream = darkColorScheme(
    primary = Color(0xFF5EEAD4), // Turquoise
    onPrimary = Color(0xFF042F2E),
    primaryContainer = Color(0xFF4C1D95), // Deep Purple Container (Mixed!)
    onPrimaryContainer = Color(0xFFE9D5FF),
    secondary = Color(0xFFD8B4E2), // Light Purple
    onSecondary = Color(0xFF311042),
    secondaryContainer = Color(0xFF0F766E), // Deep Turquoise Container (Mixed!)
    onSecondaryContainer = Color(0xFFCCFBF1),
    tertiary = Color(0xFFA78BFA),
    onTertiary = Color(0xFF2E1065),
    background = Color(0xFF080410), // Purplish dark background
    surface = Color(0xFF0C1917), // Turquoise dark surface
...
private val LightThemeForestFire = lightColorScheme(
    primary = Color(0xFF15803D), // Forest Green
    onPrimary = Color(0xFFFFFFFF),
    primaryContainer = Color(0xFFFEE2E2), // Light Red Container (Mixed!)
    onPrimaryContainer = Color(0xFF7F1D1D),
    secondary = Color(0xFFEF4444), // Red
    onSecondary = Color(0xFFFFFFFF),
    secondaryContainer = Color(0xFFDCFCE7), // Light Green Container (Mixed!)
...
private val DarkThemeForestFire = darkColorScheme(
    primary = Color(0xFF4ADE80), // Glowing Green
    onPrimary = Color(0xFF052E16),
    primaryContainer = Color(0xFF7F1D1D), // Dark Red Container (Mixed!)
    onPrimaryContainer = Color(0xFFFEE2E2),
    secondary = Color(0xFFF87171), // Light Red
    onSecondary = Color(0xFF450A0A),
    secondaryContainer = Color(0xFF14532D), // Dark Green Container (Mixed!)
    onSecondaryContainer = Color(0xFFD1FAE5),
    tertiary = Color(0xFFEF4444),
    onTertiary = Color(0xFF450A0A),
    background = Color(0xFF0F0404), // Reddish dark background
    surface = Color(0xFF06180D), // Dark Green surface
